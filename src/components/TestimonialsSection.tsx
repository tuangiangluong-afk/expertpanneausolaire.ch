...
const testimonials: Testimonial[] = [
    {
        quote: "L'outil de comparaison m'a fait gagner des heures. J'ai reçu 3 devis en 24h et l'installation de mes panneaux solaires en autoconsommation s'est déroulée à merveille. L'application Enphase de suivi de production est géniale !",
        name: "Marc Dubreuil",
        location: "Lyon",
        product: "Kit Solaire Enphase 6 kWc",
        initials: "MD",
    },
    {
        quote: "Très recommandé ! L'installateur RGE était très professionnel. Mes panneaux produisent parfaitement, même par temps nuageux. Les démarches de raccordement Enedis et de mairie ont été gérées de A à Z.",
        name: "Valérie Lemaire",
        location: "Bordeaux",
        product: "Panneaux SunPower Maxeon",
        initials: "VL",
    },
];
