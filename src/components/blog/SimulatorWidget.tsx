    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-xl border border-blue-100 ring-1 ring-blue-500/10">
            ...
            <div className="space-y-3 mb-6">
                <div className="flex items-center p-3 border rounded-lg bg-slate-50 cursor-pointer hover:border-blue-500 hover:bg-amber-50 transition-colors">
            ...
            <a href="/#simulateur" className="block w-full text-center bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg hover:shadow-blue-500/25 transition-all">
                Comparer les devis
            </a>
