            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-sm text-neutral-400 mb-4 leading-relaxed">
                        ...
                        {' '}
                        <Link href="/home/mentions-legales" className="underline text-amber-400 hover:text-amber-300 transition">
                            En savoir plus
                        </Link>
                    </p>
                    ...
                    <div className="flex flex-col gap-2">
                        <button
                            onClick={acceptAll}
                            className="w-full py-2 bg-amber-500 hover:bg-amber-400 text-neutral-900 font-bold rounded-lg transition-colors"
                        >
                            Tout accepter
                        </button>
                        <button
