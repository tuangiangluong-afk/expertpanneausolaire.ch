                ...
                await resend.emails.send({
                    ...
                    html: `
                        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                            <h1 style="color: #d97706;">Nouveau Projet à Saisir</h1>
                            ...
                            <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0; margin: 20px 0;">
                                ...
                                <ul style="list-style: none; padding: 0;">
                                    ...
                                    ${meta.monthly_bill ? `<li style="margin-bottom: 10px;">⚡ <strong>Facture Mensuelle :</strong> ${meta.monthly_bill}</li>` : ''}
                                    ${meta.roof_type ? `<li style="margin-bottom: 10px;">🏠 <strong>Type de Toit :</strong> ${meta.roof_type}</li>` : ''}
                                    ${meta.target_location ? `<li style="margin-bottom: 10px;">📍 <strong>Emplacement :</strong> ${meta.target_location}</li>` : ''}
                                </ul>
                            </div>

                            <p style="text-align: center; margin-top: 30px;">
                                <a href="https://www.expertpanneausolaire.ch/leads/unlock/${lead.id}" 
...
export async function deliverUnlockedLead(leadId: string, partnerId: string) {
    ...
    if (resend && partner.email) {
        ...
        await resend.emails.send({
            ...
            html: `
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                    <div style="background-color: #d97706; color: white; padding: 30px; border-radius: 8px 8px 0 0; text-align: center;">
                    ...
                    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 8px 8px; border: 1px solid #e2e8f0; border-top: none;">
                        ...
                        <ul style="list-style: none; padding: 0; font-size: 16px;">
                            ...
                            <li style="margin-bottom: 12px;"><strong>Email :</strong> <a href="mailto:${lead.email}" style="color: #d97706;">${lead.email}</a></li>
                            <li style="margin-bottom: 12px;"><strong>Téléphone :</strong> <a href="tel:${lead.phone}" style="color: #d97706;">${lead.phone}</a></li>
                        ...
                        <ul style="list-style: none; padding: 0; font-size: 14px; color: #475569;">
                            ...
                            ${meta.monthly_bill ? `<li style="margin-bottom: 8px;"><strong>Facture Mensuelle :</strong> ${meta.monthly_bill}</li>` : ''}
                            ${meta.roof_type ? `<li style="margin-bottom: 8px;"><strong>Type de Toit :</strong> ${meta.roof_type}</li>` : ''}
                            ${meta.target_location ? `<li style="margin-bottom: 8px;"><strong>Emplacement :</strong> ${meta.target_location}</li>` : ''}
                            ${lead.notes ? `<li style="margin-top: 15px; padding: 10px; background: #f8fafc; border-left: 4px solid #d97706;"><strong>Note Admin :</strong> ${lead.notes}</li>` : ''}
                        </ul>
