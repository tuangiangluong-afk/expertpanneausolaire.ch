    ...
    return (
        <div className="min-h-screen font-sans text-slate-900 bg-white">
            ...
            <SchemaJSON 
                ...
                site={site} 
                breadcrumbItems={[
                    { name: "Accueil", item: "https://www.expertpanneausolaire.ch" },
                    { name: "Villes", item: "https://www.expertpanneausolaire.ch/#villes" },
                    { name: site.city, item: `https://www.expertpanneausolaire.ch/ville/${resolvedParams.slug}` }
                ]} 
            />
                ...
                <div className="container mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative h-[400px] lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                            <Image
                                src={site.heroImage}
                                alt={`Installation panneaux solaires ${site.city}`}
                                fill
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
                        {SOLAR_BRANDS.map((marque) => (
                            <Link
                                ...
                                className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-center hover:border-amber-300 hover:bg-amber-50 transition"
                            >
                                <div className="font-bold text-slate-900">Solaire {marque.name}</div>
