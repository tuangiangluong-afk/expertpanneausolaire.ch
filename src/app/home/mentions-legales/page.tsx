...
export const metadata: Metadata = {
    title: "Mentions Légales - Expert Panneau Solaire",
    description: "Mentions légales, éditeur, hébergement et politique de confidentialité du réseau Expert Panneau Solaire.",
};
            ...
            <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-slate-900/90 px-4 py-3 backdrop-blur-md text-white">
                <div className="container mx-auto flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold">
                        Expert Panneau Solaire<span className="text-amber-500">.</span>
                    </span>
                </div>
            </nav>
            ...
            <main className="container mx-auto max-w-3xl px-4 py-12 lg:py-20">
                ...
                <div className="prose prose-neutral prose-lg max-w-none">
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            Le site <strong>Expert Panneau Solaire</strong> (expertpanneausolaire.ch) est édité par la société <strong>WELINK TECH</strong>.
                        </p>
                        <ul className="list-none space-y-2 pl-0">
                            ...
                            <li><strong>Contact :</strong> <Link href="/home/contact" className="underline text-amber-600">Formulaire de contact</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            L&apos;ensemble des contenus (textes, images, base de données, marque &quot;Expert Panneau Solaire&quot;) est protégé par le droit de la propriété intellectuelle. Toute reproduction non autorisée est interdite.
                        </p>
                    </div>
